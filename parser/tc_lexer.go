...
var tclexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func tclexerLexerInit() {
	staticData := &tclexerLexerStaticData
...
// tcLexerInit initializes any static state used to implement tcLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewtcLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func TcLexerInit() {
	staticData := &tclexerLexerStaticData
	staticData.once.Do(tclexerLexerInit)
}

// NewtcLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewtcLexer(input antlr.CharStream) *tcLexer {
	TcLexerInit()
	l := new(tcLexer)
...
const (
	...
	tcLexerNAME            = 10
	tcLexerINTEGER         = 11
	tcLexerDECIMAL_INTEGER = 12
	tcLexerFLOAT_NUMBER    = 13
	tcLexerSTRING          = 14
	tcLexerOP              = 15
	tcLexerMOD             = 16
	tcLexerBLOCK_COMMENT   = 17
	tcLexerWhiteSpace      = 18
	tcLexerNewLine         = 19
)
